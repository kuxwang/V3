...
const base = 'http://www.maimaiwh.com';
...
export const withdrawalStatus = function (params, callback) {
  setParams(Object.assign(params, commissions.withdrawalStatus), callback)
};
...
export const RecordBill = function (params, callback) {
  setParams(Object.assign(params, commissions.recordBill), callback)
};
