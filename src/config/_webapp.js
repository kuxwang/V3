...
export var _webapp = {
  ...
  requestx: function (params, callback) {
    ...
    // var paramsx = _webapp.getSign(params);
    var accessToken = _webapp.getAccessToken();

    $.ajax({
      type: params.method,
      url: params.url + '?access_token=' + accessToken.access_token,
      data: _webapp.getSign(params.data),
  ...
  getSign: function (res) {
    if (res === {} || res === '' || typeof res === 'undefined') {
      res = {};
    }
  ...
  getSessionkey : function(){
    return 'ece28c6506cacb4dafc8709c7d34dcdb';
  },
